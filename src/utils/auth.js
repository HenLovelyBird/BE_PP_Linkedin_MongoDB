...
passport.use(new LocalStrategy(User.authenticate())) // this strategy will be used when we ask passport to passport.authenticate("local")
...
module.exports = {
    getToken: (user) => jwt.sign(user, jwtOptions.secretOrKey, { expiresIn: 1000 }) 
